...
class SignScreenState extends State<SignScreen> {
  ...
  Widget _buildConfirmPasswordTF() {
    ...
    return Column(
      ...
      children: <Widget>[
        Text(
          !trade ? 'Confirmer votre Mot de Passe' : 'Confirm your password',
          style: kLabelStyle,
        ),
        SizedBox(height: 10.0),
        Center(
          ...
          onPressed: () {
            if (_formKey.currentState.validate()) {
              ...
              Navigator.pushNamed(
                context,
                '/SignConfirm.dart',
                arguments: ScreenArgument(_email, _password, trade),
              );
            }
          }),
    );
        ...
        child: RichText(
          text: TextSpan(
            children: [
              ...
              TextSpan(
                text: !trade ? 'Connectez-vous' : 'Log in',
                style: TextStyle(
                  fontFamily: 'Myriade',
                  color: Color.fromRGBO(209, 62, 150, 1),
                  fontSize: 18.0,
