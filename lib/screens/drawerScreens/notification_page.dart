...
class NotificationsPage1 extends StatefulWidget {
  ...
  NotificationsPage1({Key key, this.rangeCallBack, this.user})
      : super(key: key);
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                ...
                return Column(children: [
                  ...
                  ExpansionTile(
                    title: Text(
                      !trade ? 'Géolocalisation' : 'Geolocation',
                      style: TextStyle(
                        color: Colors.black,
                      ),
                    ),
