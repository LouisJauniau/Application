...
class _listeScreenState extends State<listeScreen> {
  ...
  String dropdownValue = 'Sélectionner un parcours';
                                  ...
                                  Consumer<ArticleProvider>(
                                    builder: (_, articlesData, child) {
                                      _article = articlesData.markerToArticle(
                                          articleLists[index].id);
                                      if (articleLists[index]
                                          .audio
                                          .isNotEmpty &&
                                      ...
                                      return InkWell(
                                        onTap: () {
                                          ...
                                          i++) {
                                            if (articleMarker[i].idArticle ==
                                                articleLists[index].id) {
                                              widget.latling1 =
                                                  articleMarker[i].latitude;
                                              widget.latling2 =
                                                  articleMarker[i].longitude;
                                            }
                                          }
                                          ;
