...
import '../widgets/markerWidgets/articleItem.dart';
...
class MarkerProvider with ChangeNotifier {
    ...
    await FirebaseFirestore.instance
        ...
        .then((QuerySnapshot querySnapshot) =>
            querySnapshot.docs.forEach((QueryDocumentSnapshot element) {
              ...
              // Si l'article à une photo, alors on set hasPhoto à true
              // Récupération de l'article
              FirebaseFirestore.instance
                  .collection('articles')
                  .doc(customMarker.idArticle)
                  .get()
                  .then((DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists) {
                  // Si l'article à une photo, alors on set isVisble à true
                  if (documentSnapshot['imageUrl'] != null && documentSnapshot['imageUrl'].toString().isNotEmpty) {
                    customMarker.hasPhoto = true;
                  }
                }
              });
  ...
  /// @return  Liste des markers
  List<CustomMarker> getAllMarkers() {
