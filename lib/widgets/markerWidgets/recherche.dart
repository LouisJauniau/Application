...
class Recherche extends StatefulWidget {
  Recherche({Key key, this.showMap, this.filterMap}) : super(key: key);
              ...
              return GestureDetector(
                ...
                child: Dismissible(
                  ...
                  child: AlertDialog(
                    ...
                    title: Text(
                      !trade ? item.label : item.labelEN,
                      style: TextStyle(
                          color: Color.fromRGBO(209, 62, 150, 1), fontSize: 20),
                    ),
                    content: Text(
                      !trade ? item.definition : item.definitionEN,
                    ...
                    TabBar(
                      ...
                      tabs: [
                        ...
                        Tab(
                            ...
                            text: !trade ? 'Définitions' : 'Definitions'),
                      ],
                    ),
                    Expanded(
