...
///Fonctionnalité expérimental qui n'a pas été mise en place, faute de moyen
///Début d'implementation d'un hostorique de notification, qui doit être affiche dans l'onglet nofitication
          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Container(
              ...
              child: Image(
                height: 40,
                width: 40,
                image: AssetImage(getDescription().isNotEmpty
